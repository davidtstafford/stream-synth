 ...
 * 
 * Modal dialog for creating and editing event actions.
 * Provides tabbed interface for configuring text, sound, image, and video alerts.
 * 
...
interface ActionEditorProps {
  ...
  channelId: string;
  eventType?: string;             // For create mode
...
export const ActionEditor: React.FC<ActionEditorProps> = ({
  ...
  const [formData, setFormData] = useState<EventActionPayload>({
    ...
    // Sound
    sound_enabled: action?.sound_enabled ?? false,
    sound_file_path: action?.sound_file_path || null,
    sound_volume: action?.sound_volume ?? 0.5,
    
    // Image
    image_enabled: action?.image_enabled ?? false,
    ...
    // Video
    video_enabled: action?.video_enabled ?? false,
  ...
  return (
    <div className="action-editor-backdrop" onClick={handleCancel}>
      <div className="action-editor-modal" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        <div className="action-editor-header">
          ...
          <button className="close-button" onClick={handleCancel} title="Close (Esc)">
            ✕
          </button>
        </div>
        
        {/* Tab Navigation */}
        <div className="action-editor-tabs">
          <button
        ...
        {/* Tab Content */}
        <div className="action-editor-content">
          {/* General Tab */}
          {activeTab === 'general' && (

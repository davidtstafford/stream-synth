        ...
        if (result.success && result.events) {
          ...
          const chatMessages: ChatMessage[] = result.events
            ...
            .map(event => {
              ...
              return {
                id: event.id,
                username: event.viewer_username || data.chatter?.login || 'Unknown',
                displayName: event.viewer_display_name || data.chatter?.name,
  ...
  useEffect(() => {
    const handleNewEvent = (eventData: any) => {
      ...
      const newMessage: ChatMessage = {
        ...
        username: eventData.viewer_username || data.chatter?.login || 'Unknown',
        displayName: eventData.viewer_display_name || data.chatter?.name,
        message: data.message?.text || '',
